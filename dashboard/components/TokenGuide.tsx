        ...
        <div className="flex flex-col gap-2 font-mono text-xs">
          ...
          <div className="flex items-start gap-3">
            ...
            <span className="text-muted leading-tight">
              Scope: check <span className="border border-border bg-[#111111] text-mono-value px-1 mx-0.5">repo</span> (for artifact access) and <span className="border border-border bg-[#111111] text-mono-value px-1 mx-0.5">workflow</span> (for manual scans)
            </span>
          </div>
          ...
          <div className="flex items-start gap-3 mt-6">
            ...
            <a
              href="https://github.com/settings/tokens/new?scopes=repo,workflow&description=SecretShield+Dashboard"
              target="_blank"
